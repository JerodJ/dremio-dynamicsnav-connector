...
@SourceType(value = "DynamicsNAVARP", label = "DynamicsNAV",uiConfig = "dynamicsnav-layout.json")
public class DynamicsNAVConf extends AbstractArpConf<DynamicsNAVConf> {
  private static final String ARP_FILENAME = "arp/implementation/dynamicsnav-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.dynamicsnav.DynamicsNAVDriver";
